#ACtualizar
## Formulario de inscripción de Espacios(Stand)/promotores externo e interno agregar: 
1. Dirección(Campo texto) (OBLIGATORIO*)
2. ¿Qué tipo de organización eres? (Campo select) (OBLIGATORIO*)
•	Persona Natural
•	Sociedades por Acciones Simplificadas S.A.S.
•	Sociedad Limitada
•	Las demás organizaciones civiles, corporaciones, fundaciones
•	Empresas unipersonales
•	Corporaciones, asociación y fundaciones creadas para adelantar actividades en comunidades indígenas.
•	Sociedad Anónima
...
•	Corporaciones
•	Organización no formalizada
•	Otro: ___ (Respuesta abierta corta)

3. ¿Cuál es tu actividad o vínculo con la cadena de valor del café? (campo select )(OBLIGATORIO*)
•	Productor de café tostado con marca propia
•	Transformador de productos derivados del café
•	Distribuidor de productos de café
•	Barista / establecimiento especializado en café
•	Proveedor de equipos, maquinaria o insumos para café 
•	Artesanías/productos con identidad cafetera 
•	Servicios relacionados con el café 
•	Organización o asociación cafetera
...
", al final el link de "la Política de Tratamiento de Datos Personales de la Gobernación de Nariño" (poder configurar el link  desde el admin)
2. Poder adecuar la ubicación de lat y long manualmente en campos texto (Ya existe interno, incorporarlo en el externo) y que se actualice en el mapa mientras se digita y se sale del campo.
3. El logo al subirlo, que permita configurar para centrarlo, aumentarlo o reducir su tamaño.
